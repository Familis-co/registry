...
/**
 * Renders a tile previewing a box-shadow token resolved from a CSS custom property.
 *
 * @param props - Component props.
 * @param props.value - CSS custom property name of the shadow token (e.g. `--shadow-md`).
 */

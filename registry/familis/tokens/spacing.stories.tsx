...
/**
 * Renders a table row showing a spacing step as rem, pixels, and a bar preview,
 * computed as a multiple of the `--spacing` base token.
 *
 * @param props - Component props.
 * @param props.name - Display name of the spacing step.
 * @param props.value - Multiplier applied to the `--spacing` base token.
 */

...
/**
 * Renders a table row showing a typography token's resolved value and a live preview.
 *
 * @param props - Component props.
 * @param props.value - CSS custom property name of the token (e.g. `--font-sans`).
 * @param props.name - Display name of the token.
 * @param props.styleKey - CSS property the resolved value is applied to in the preview.
 * @param props.children - Sample content rendered in the preview cell.
 */
const TypographyRow = ({
  value,
  name,
